        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 50,),
              Text("Launch the Luminious", style: TextStyle(
                  color: Colors.black87.withOpacity(0.8),
                  fontSize: 25,
                  fontWeight: FontWeight.w600
              ),),
        ...
        child: Row(
          children: <Widget>[
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text("The Luminious", style: TextStyle(
                  color: Color(0xffFC9535),
                  fontSize: 19
                ),),
                SizedBox(height: 2,),
                Text("Choose the right Tools & Techniques", style: TextStyle(
                  fontSize: 15
                ),)
              ],
            ),
            ...
            Container(
              ...
              child: Text("Launch", style: TextStyle(
                color: Colors.white,
                fontSize: 13,
