...
import 'package:doctor_booking_app/views/ten.dart';
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Text(
"Does your client have a need to use the product or service in a phased manner?",                                    style: TextStyle(fontSize: 32),
                                  ),
                      ...
                      Center(
                        child: Container(
                          ...
                          child: Lottie.network(
                            'https://assets3.lottiefiles.com/packages/lf20_uhoBnYFtuw.json',
                            repeat:  false,
                            reverse: false,
                            animate: true,
                          ),
